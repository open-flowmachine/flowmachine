...
import { EditProjectForm } from "@/presentation/feature/editable-project-details/edit-project-form";
import type { EditProjectFormValues } from "@/presentation/feature/editable-project-details/edit-project-form-schema";
import { EditableProjectDetails } from "@/presentation/feature/editable-project-details/editable-project-details";
import { useEditProjectForm } from "@/presentation/feature/editable-project-details/use-edit-project-form";
import { useGetProject } from "@/presentation/hook/project/use-get-project";
import { useUpdateProject } from "@/presentation/hook/project/use-update-project";
...
export function EditableProjectDetailsPage({
  ...
  const { data, isPending, isError } = useGetProject(id, { initialData });
