...
import { EditGitRepositoryForm } from "@/presentation/feature/editable-git-repository-details/edit-git-repository-form";
import type { EditGitRepositoryFormValues } from "@/presentation/feature/editable-git-repository-details/edit-git-repository-form-schema";
import { EditableGitRepositoryDetails } from "@/presentation/feature/editable-git-repository-details/editable-git-repository-details";
import { useEditGitRepositoryForm } from "@/presentation/feature/editable-git-repository-details/use-edit-git-repository-form";
import { useGetGitRepository } from "@/presentation/hook/git-repository/use-get-git-repository";
import { useUpdateGitRepository } from "@/presentation/hook/git-repository/use-update-git-repository";
...
export function EditableGitRepositoryDetailsPage({
  ...
  const { data, isPending, isError } = useGetGitRepository(id, { initialData });
