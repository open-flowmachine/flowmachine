...
2. **Generate the spec** to `doc/generated/specs/YYYY-MM-DD-<name>.md`:
...
```
AskUserQuestion(
  question: "Spec created at doc/generated/specs/YYYY-MM-DD-<name>.md. How would you like to proceed?",
  options: [
